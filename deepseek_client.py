...
_TOOL_ORDER = [
    ...
    'secret_store', 'kv_store', 'media_ffmpeg', 'mv_compose', 'mv_produce', 'webdav', 'run_wechat_writer', 'daily_brief', 'create_plugin', 'html_render', 'html_to_ppt', 'html_to_pdf', 'ppt_layout_check',
...
_HINT_ORDER = [
    ...
    ('合成视频', '图片转视频', '加字幕', '配乐', '混音', '运镜', '转场'),     ('图生图', '参考图', '保持角色一致', '改图', '修图', '编辑图片'), ('微电影', 'mv', '一键成片', '分镜', '故事板', '短片', '配音成片'), ('歌词', '卡点', '对词', '对轴', '歌曲', '音乐视频', '抖音mv'),
    ('二维码', '生成二维码', '识别二维码'), ('截屏', '截个屏', '屏幕截图', '截屏看看'), ('rss', '订阅源', '聚合阅读', '订阅列表'),
    ('github搜索', '搜开源项目', '找仓库', '搜代码库'), ('热门仓库', 'B站热门', 'bilibili', '技术问答', 'stackoverflow'), ('被墙', '爬墙', '代理抓取', '绕过封锁', '抓不了'), ('网络诊断', '断网', '连不上', '网络问题', '上不去网'),
