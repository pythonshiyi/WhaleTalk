# 鲸语 WhaleTalk 技术文档（Web 版 · v3.16.12）
...
- **版本单一源**：`config_defaults.VERSION`（当前 3.16.12）。备份产物 `WhaleTalk_v{version}_*.zip`；打包产物 `WhaleTalk.exe`。README/SECURITY 的版本表述须与该常量一致。
